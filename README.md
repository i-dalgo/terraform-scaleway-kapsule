...
| <a name="input_cluter_private_network_id"></a> [cluster\_private_network_id](#input\_cluster\_private_network_id) | The ID of the Private Network for the Kubernetes cluster | `string` | n/a | yes |
